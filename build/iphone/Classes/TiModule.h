...
/**
 The base class for all Bookster modules
 */
...
/**
 Bookster Platform calls this method on startup.
 */
-(void)startup;

/**
 Bookster Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Bookster Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Bookster Platform calls this method on resume.
 @param sender The sender of the event.
 */
