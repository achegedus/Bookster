 ...
 * Copyright (c) 2009-2011 by Bookster, Inc. All Rights Reserved.
...
//@interface BooksterObject : NSObject
//@end

@interface BooksterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BooksterObject class]])
		{
			for (NSString *key in [[(BooksterObject*)o modules] allKeys])
			{
