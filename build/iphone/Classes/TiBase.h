...
// in simulator we redefine to format for Bookster Developer console
...
{\
	NSString * exceptionName = [@"org.bookster." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bookster";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBooksterNativeItemNone = -1, 
	UIBooksterNativeItemSpinner = -2,
	UIBooksterNativeItemProgressBar = -3,
	
	UIBooksterNativeItemSlider = -4,
	UIBooksterNativeItemSwitch = -5,
	UIBooksterNativeItemMultiButton = -6,
	UIBooksterNativeItemSegmented = -7,
	
	UIBooksterNativeItemTextView = -8,
	UIBooksterNativeItemTextField = -9,
	UIBooksterNativeItemSearchBar = -10,
	
	UIBooksterNativeItemPicker = -11,
	UIBooksterNativeItemDatePicker = -12,
	
	UIBooksterNativeItemInfoLight = -13,
	UIBooksterNativeItemInfoDark = -14,
	
	UIBooksterNativeItemDisclosure = -15,
	
	UIBooksterNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Bookster instances of
